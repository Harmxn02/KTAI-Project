...
We use BLEU-1 through BLEU-4 as the evaluation metrics, reporting all four variants to provide a more comprehensive picture of n-gram overlap between generated and reference tails. Following the convention in the original code, \code{none} responses are excluded from scoring, so that only valid generations are evaluated.
